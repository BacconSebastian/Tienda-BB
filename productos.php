...
<div class="busqueda_desplegada">
    ...
    <article class="catalogo_productos">
        <a href="productos/olaplex.php">OLAPLEX</a>
        <a href="productos/ossono.php">OSSONO</a>
        <a href="productos/frilayp.php">FRILAYP</a>
        <a href="productos/kits.php">KITS</a>
    </article>
